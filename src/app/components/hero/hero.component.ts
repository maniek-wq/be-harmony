  ...
  template: `
    <section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-white" style="transform: translateZ(0);">
      ...
      <div class="absolute inset-0 z-0 overflow-hidden" style="transform: translateZ(0);">
        <img src="assets/img/10507.jpg" alt="Centro de Entrenamiento EMS" class="hero-bg-img img-scale-mobile" style="animation-delay: 0s;">
        <img src="assets/img/2.jpeg" alt="Entrenamiento EMS Be Harmony" class="hero-bg-img img-scale-mobile" style="animation-delay: 6s;">
        <img src="assets/img/6.jpeg" alt="Bienestar y relax" class="hero-bg-img img-scale-mobile" style="animation-delay: 12s;">
        <img src="assets/img/5.jpg" alt="Zona de entrenamiento" class="hero-bg-img img-scale-mobile" style="animation-delay: 18s;">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20 md:py-32">
        ...
        <h1 appScrollReveal [revealDelay]="0.1"
          ...
          Cuida tu cuerpo.<br>
          <span class="text-terracotta">Cuida de ti.</span><br>
          <span class="text-mint-700">Encuentra la armonía.</span>
        </h1>

        <p appScrollReveal [revealDelay]="0.2"
           class="max-w-2xl mx-auto text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">
          Centro moderno de entrenamiento EMS y bienestar corporal que combina tecnología avanzada 
          de estimulación muscular eléctrica con un enfoque integral de salud.
        </p>
        ...
        <div appScrollReveal [revealDelay]="0.5" class="mt-16 md:mt-24">
          <div class="flex flex-col items-center gap-2 text-gray-400">
            <span class="text-xs uppercase tracking-widest">Desplázate hacia abajo</span>
