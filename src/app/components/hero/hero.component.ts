...
@Component({
  ...
  template: `
    <section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-white" style="transform: translateZ(0);">
      <!-- Background: tylko zdjęcia (rotacja) -->
      <div class="absolute inset-0 z-0 overflow-hidden" style="transform: translateZ(0);">
        <img src="assets/img/10507.jpg" alt="Gabinet terapii ciała" class="hero-bg-img img-scale-mobile" style="animation-delay: 0s;">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-olive-50/95 via-white/80 to-white/40 sm:from-olive-50/90 sm:via-white/70 sm:to-white/30 z-[2]"></div>
        <!-- Additional gradient from bottom for content blending -->
        <div class="absolute inset-0 bg-gradient-to-t from-white via-transparent to-transparent z-[2]"></div>
      </div>
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20 md:py-32">
        ...
        <h1 class="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
          Zadbaj o ciało.<br>
          <span class="text-terracotta">Zadbaj o siebie.</span><br>
          <span class="text-olive">Znajdź harmonię.</span>
        </h1>
