      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10" appScrollReveal>
          <h2 class="font-display text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            Cómo <span class="text-terracotta">llegar</span>
          </h2>
          <p class="text-gray-500">Encuéntranos en el mapa</p>
        </div>

        <div appScrollReveal class="rounded-2xl overflow-hidden shadow-lg border border-mint-200">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3281.0489344925395!2d14.568150677490866!3d53.508912072336756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47aa0b706cad80a9%3A0x8d30628b3986b3cb!2sOrzechowa%2033%2C%2072-010%20Prz%C4%99socin!5e1!3m2!1ses!2ses!4v1772205794266!5m2!1ses!2ses"
            width="100%"
            height="450"
            style="border:0;"
            allowfullscreen
