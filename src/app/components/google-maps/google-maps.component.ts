...
@Component({
  ...
  template: `
    <section class="py-16 md:py-20 bg-cream-100">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div appScrollReveal class="mt-6 text-center">
          <p class="text-gray-600 flex items-center justify-center gap-2">
            ...
            <a href="https://maps.google.com/?q=Orzechowa+33B%2Flok.7,+Przęsocin" target="_blank" rel="noopener" class="hover:text-terracotta transition-colors">
              Przęsocin, ul. Orzechowa 33B/lok.7
            </a>
          </p>
        </div>
      </div>
