...
@Component({
    ...
    <div *ngIf="isVisible"
      ...
      <div class="bg-white/90 backdrop-blur-md border-t border-olive/30 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] px-4 py-3">
        <a href="tel:+48601160646"
           class="flex items-center justify-center gap-3 w-full py-3.5 bg-terracotta text-white font-semibold rounded-2xl hover:bg-terracotta-600 hover:shadow-warm active:scale-[0.98] transition-all duration-200 shadow-lg">
