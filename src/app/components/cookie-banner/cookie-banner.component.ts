    ...
    <div *ngIf="showBanner"
      ...
      <div class="max-w-4xl mx-auto bg-gray-900 text-white rounded-2xl p-6 shadow-2xl border border-gray-700">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
          <div class="flex-1">
            <h3 class="font-semibold text-sm mb-1">🍪 Este sitio usa cookies</h3>
            <p class="text-gray-400 text-xs leading-relaxed">
              Utilizamos cookies para ofrecerte la mejor experiencia en nuestra web. 
              Al continuar navegando, aceptas su uso.
              <a href="/politica-de-privacidad" class="text-mint hover:text-mint-200 underline ml-1">Más información</a>
            </p>
          </div>
